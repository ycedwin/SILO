...
<head>
	<!-- Page introduction
		 This is a index page(welcome page) tends to help people navigate to other pages.-->
...
<body>
  <div class="container outside">
	...
	<div class="col s12 imageparent" id="introduction">


		<img src="images/pic.jpg" width="100%">

		<a href="search.php" id="startButton">
    ...
    <div class="ui active progress" id="progressBar">
      <div class="bar">
          <div class="progress"></div>
      </div>
      <div class="label">Loading stations</div>
    </div>
  ...
  <script type="text/javascript">
      $('#startButton').click(function(){
          $('#introduction').fadeTo("slow",0);
          $('#progressBar').css("overflow","visible");
      });
  </script>
